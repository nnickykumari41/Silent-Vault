...
import { Twitter, Linkedin, Instagram, Facebook, Shield } from "lucide-react"
  ...
  return (
    <div className="relative">
      <div className="absolute -top-[20vw] left-0 right-0 w-full h-[50vw] z-0 overflow-hidden">
        <Image src="/images/footer-bg.png" alt="Silent recovery landscape" fill className="object-cover" priority />
      </div>
      ...
      <footer id="contact" className="relative z-20 border-t border-border py-16 px-6 bg-background">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
            <div className="col-span-2 md:col-span-1">
              <Link href="/" className="flex items-center gap-2 mb-4">
                ...
                <span className="text-base font-medium text-foreground">SilentVault</span>
              </Link>
              <p className="text-sm text-muted-foreground mb-6">Private recovery for self-custody.</p>
          ...
          <div className="pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-xs text-muted-foreground">© 2026 SilentVault. All rights reserved.</p>
            <p className="text-xs text-muted-foreground">CoFHE-powered encrypted recovery protocol</p>
          </div>
        </div>
      </footer>
    </div>
