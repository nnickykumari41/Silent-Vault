...
export interface MockTaskManagerInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "decryptResultSigner",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "setDecryptResultSigner",
    values: [AddressLike]
  ): string;
...
export interface MockTaskManager extends BaseContract {
  ...
  setDecryptResultSigner: TypedContractMethod<
    [signer: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "decryptResultSigner"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
