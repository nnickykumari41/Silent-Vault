...
const defaultTopProperties = [
  { page: "Encrypted wills", visitors: 245 },
  { page: "Recovery notes", visitors: 189 },
  { page: "Wallet map", visitors: 156 },
  { page: "Legal contacts", visitors: 98 },
]
    ...
    >
      <div className="mb-6 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <h3 className="text-lg font-semibold text-slate-900">Vault Activity</h3>
      ...
      <div className="mb-6 grid grid-cols-2 gap-4">
        ...
        >
          <div className="flex items-center gap-2 mb-1">
            ...
            <p className="text-sm opacity-80">Encrypted Items</p>
          </div>
        ...
        >
          <div className="flex items-center gap-2 mb-1">
              <LockKeyhole className="w-4 h-4 opacity-60" />
            <p className="text-sm opacity-80">ACL Events</p>
          </div>
          <AnimatePresence mode="wait">
            <motion.p
              key={pageViews}
      ...
      <div className="mb-6">
        <p className="mb-3 text-sm font-medium text-slate-700">Recovery Signal</p>
        <div className="h-32">
      ...
      <div>
        <p className="mb-3 text-sm font-medium text-slate-700">Private Inventory</p>
